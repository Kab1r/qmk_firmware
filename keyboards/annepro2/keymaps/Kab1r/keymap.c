...
#define ESC_FN2 (LT(_FUNCTION2, KC_ESC))
...
const uint16_t keymaps[/* LAYERS */][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    /* Function Layer
     *  ,-----------------------------------------------------------------------------------------.
     *  |FN L2| F1  | F2  | F3  | F4  | F5  | F6  | F7  | F8  | F9  | F10 | F11 | F12 | Del       |
     *  |-----------------------------------------------------------------------------------------+
     *  |        |     |     |     |     |     |     |     |     |     |PrtSc| Home| End |        |
     *  |-----------------------------------------------------------------------------------------+
     *  |         |     |     |     |     |     | <-  |  V  |  ^  | ->  | PGU | PGD |             |
    ...
    [_FUNCTION] = KEYMAP(                                                                                                               /* Function Layer */
        ESC_FN2, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,   KC_F11,  KC_F12, KC_DEL,    //
    ...
    [_FUNCTION2] = KEYMAP(                                                                                                              /* Function Layer */
    ...
    /* Hardware Layer
     *  ,-----------------------------------------------------------------------------------------.
     *  | USB | BT1 | BT2 | BT3 | BT4 |MREC1|MPLY1|MREC2|MPLY2|MODE |TOGGL|SPEED|BRIGH| BT_UNPAIR |
     *  |-----------------------------------------------------------------------------------------+
     *  |        |     |     |     |     |     |     |     |     |     |     |     |     |        |
     *  |-----------------------------------------------------------------------------------------+
     *  |EndMacroR|     |     |     |     |     |     |     |     |     |     |     |             |
    ...
    [_HARDWARE] = KEYMAP(                                                                                                               /* Hardware Layer */
        AP_USB,  AP_BT1,  AP_BT2,  AP_BT3,  AP_BT4,  DM_REC1, DM_PLY1, DM_REC2, DM_PLY2, LED_MOD, LED_TOG, LED_SPD, BRIGHTN, BT_UNPR,   //
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   //
        DM_RSTP,     _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,      _______,   //
        _______,           _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,         _______,   //
        _______,     _______,     _______,                  _______,                  _______,     _______,     _______,     _______    //
        ),                                                                                                                              /* Hardware Layer */
    /* Mouse Layer
